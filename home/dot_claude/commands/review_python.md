...
If user specified a path argument (e.g., `/review_python src/api/`), use that path as the review target.
...
/review_python src/api/

# Review specific file
/review_python src/services/user_service.py
